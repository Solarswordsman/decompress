...
// ------------------------------------------------------------
// Persistent storage helpers (graceful fallback to memory)
// ------------------------------------------------------------
const KEY_DATA = "decompress:exercises:v1";
const KEY_ROUTINE = "decompress:routine:v1";
const KEY_THEME = "decompress:theme:v1";
